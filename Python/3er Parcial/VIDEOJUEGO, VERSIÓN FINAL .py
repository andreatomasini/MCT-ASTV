...
if sit==("front"):
  ...
  input()
  print("From that gir you met,Allison, she wants to kill you ☠️")
  input()
  ...
  input()
  print("Ok if you want some proofs I can show them to you...... The bot show you the proof 😖")
  input()
  ...
  while True:
   ...
   if b==46:
    ...
    break
  input()
  print("You write the code and the bomb explotes so Alisson gets killed")
  input()
  print("You win []++++||=======>")
  if walk==("run"):
...
if sit==("back"):
 ...
 if qu==("no"):
  ...
  input()
 print("When you sit down, your remember that you have an old computer, try to guess the password (two numbers)🤪:")
 input()
 c=25
 fo=int(input("Guess the password:(two numbers)🥳😒:\n"))
 while fo!=c:
 ...
 if ra==("b"):
  ...
  input()
 print("You think, (Apparently this diary is right, but in what course do you want to take your life, will it be good or bad?) 🤔🤔🤔")
 input()
 ...
 input()
 print(on,"after being bullied during his time at school when he grew up he decided that it would never happen again, so he learned martial arts, almost everything, and became an expert in each one of them, since he made that promise to himself he hasn't let them abuse him or someone else again, well although that was not his job, he is even better at his job than in martial arts😱😱🤔🦈")
 input()
 print("You wake up and go to school, you are very worried about what happened yesterday and you want to see how Rain is doing, when you get to school you sit down and you notice Rain a little weird so you invite him to eat🍥🧃🍇")
 input()
 ...
 input()
 print("This is strange, you couldn't find anything about Rain, but something wasn't right, you knock on the door of her house and a lady opens it and says, are you the one who came to see the house?, where are your parents, don't you want to see the house?, and you asked, is not here were Rain live?")
 input()
 ...
 if bna==("6"):
  print("You leave Rain at his house and then try to follow the person who was following Rain, but after following him for three streets you lost him in the dadkness. Then you go to your house ...") 
 if bna==("7"):
