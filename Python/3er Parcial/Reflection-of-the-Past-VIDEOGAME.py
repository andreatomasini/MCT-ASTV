...
if sex==("boy"):
 print("Wake up son🌟")
input()
print("You open your eyes and see your dad waking you up to go to school, this means something, THIS WAS NOT A DREAM you are in the 80s 😴")
input()
print("I have no other option, (you get out of bed, you go to take a bath, you change into your new uniform and go down to breakfast 😄😏)")
input()
...
input()
if s==("yes"):
  print("Hello, I'm new here I'm going to start high school, nice to meet you 🤠")
  input()
  print("Nice to meet you my name is Evan,I hope we get along, I think we are in the same grade (Evan walks and enters the bus, you follow him and sit down)😶")
input()
...
if variable==10:
  ...
  print("The number is 20 and you pass, your friend feels happy because you got it right, but the teacher start thinking that your friend passed you the answer and send you to the principal office.")
elif variable==30:
...
print("What!? that's imposible, she was my friend even in my other life when I really was at the age of 11.")
...
input()
print("He is ready to atack, and Allison scapes fast before the robot killed her")
input()
print("what a shame")
input()
print("but at least we escape")

if walk==("run"):
  print("You run as fast as you can and then you scape hopefully the principal robot is there and he asks what happened?")
input()
...
if sit==("back"):
 ...
 input()
 print("After you leave, you went to your house but your father is waiting you in the frontdoor of the house and shows you a card from school saying you are too distracted and low in grades so he said that after school you have to stay in home and nothing of run away from home.... You agree 🤥 ")
 input()
